...
TEST(object, signals)
{
    ...
    auto parent_change_notifier =
        [ & ]([[maybe_unused]] g::project::object_ptr obj)
    { parent_change_count++; };
    g::project::object_ptr parent =
        g::project::object::create("Parent", nullptr);
    g::project::object_ptr child = g::project::object::create("Child", nullptr);

    parent->on_children_list_changed.connect(children_list_change_notifier);
    child->on_parent_changed.connect(parent_change_notifier);
